...
export function SearchAccount({
  ...
  /*  const handleSearch = async () => {
    await fetch(`${import.meta.env.VITE_APP_API}/findUser`, {
  ...
  const handleSearch = () => {
    ...
    return fetch(`${import.meta.env.VITE_APP_API}/findUser`, {
      method: "POST",
      ...
      .then(async (res) => {
        ...
        if (!res.ok) {
          // mensajes 4xx/5xx devueltos por tu backend
          throw new Error(data.message || "Something went wrong.");
        }
        return data; // { email, picture }
      })
      .then((data) => {
        setUserInfos(data);
        setVisible(1);
